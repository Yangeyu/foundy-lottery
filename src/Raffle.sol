...
contract Raffle is VRFConsumerBaseV2Plus, AutomationCompatibleInterface {
     ...
     * Errors
     */
    error Raffle_NotNeedToPerformUpkeep(uint256 currBalance, uint256 playerNum, RaffleState state);
    ...
    function performUpkeep(bytes calldata) external override {
        ...
        if (!upkeepNeeded) {
            revert Raffle_NotNeedToPerformUpkeep(address(this).balance, s_players.length, s_raffleState);
        }
